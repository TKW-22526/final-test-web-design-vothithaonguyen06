...
Đẩy toàn bộ mã nguồn dự án lên GitHub.
Bật GitHub Pages cho repository.
Kiểm tra website hoạt động đúng trên trình duyệt.
Sao chép liên kết website GitHub Pages.
Vào hệ thống LMS.
Dán liên kết website vào mục "Kết thúc môn".
Nộp báo cáo kết thúc môn theo đúng mẫu được cung cấp.
6. Nội dung cần nộp
...
Họ và tên:Võ Thị Thảo nguyên
Mã số sinh viên:110124247
Lớp:DA24TTC
Tên đề tài:
